    ...
    <div class="container">
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <p class="intro-text">Développeuse web fullstack junior</p>
  ...
  <div class="container">
    ...
    <div id="row">
      <div class="col-xs-6 col-md-3 col-sm-6">
        <div class="thumbnail"> <img src=<?= $this->assetUrl("img/team/01.jpg");?> alt="..." class="img-thumbnail team-img">
          <div class="caption">
            <h3>John Doe</h3>
            <p>Founder / CEO</p>
          </div>
      ...
      <div class="col-xs-6 col-md-3 col-sm-6">
        <div class="thumbnail"> <img src=<?= $this->assetUrl("img/team/02.jpg");?> alt="..." class="img-thumbnail team-img">
          <div class="caption">
            <h3>Mike Doe</h3>
            <p>Web Designer</p>
          </div>
      ...
      <div class="col-xs-6 col-md-3 col-sm-6">
        <div class="thumbnail"> <img src=<?= $this->assetUrl("img/team/03.jpg");?> alt="..." class="img-thumbnail team-img">
          <div class="caption">
            <h3>Jane Doe</h3>
      ...
      <div class="col-xs-6 col-md-3 col-sm-6">
        <div class="thumbnail"> <img src=<?= $this->assetUrl("img/team/04.jpg");?> alt="..." class="img-thumbnail team-img">
          <div class="caption">
            <h3>Larry Show</h3>
            <p>Project Manager</p>
          </div>
